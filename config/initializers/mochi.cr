require "mochi"
# Uncomment this is you plan to use a custom mailing class
#
# Make sure to comment out `require "mailers/**"` in the amber mailer initializer
# require "../../src/mailers/**"
require "mochi/mailers/default_mailer"
Mochi.setup do |config|
  ...
  # If you change this, make sure to implment all abstract methods
  # & make sure to comment out the require mailer at the top of this file
...
# Uncomment the first line below along with
# any providers you wish to use.
